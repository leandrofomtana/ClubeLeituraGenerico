...
namespace ClubeLeitura.ConsoleApp.Telas
{
    public class TelaEmprestimo : TelaBase
    {
        ...
        public void RegistrarEmprestimo()
        {
            ...
            bool revistaEncontrada = controladorRevista.ExisteRegistro(idRevista);
            ...
            bool amigoEncontrado = controladorAmigo.ExisteRegistro(idAmigo);
        ...
        public void RegistrarDevolucao()
        {
            ...
            bool emprestimoEncontrado = controladorEmprestimo.ExisteRegistro(idEmprestimo);
